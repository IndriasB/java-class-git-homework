public class IsItPassByReference {
	...
	public static void main(String[] args) {
		...
		System.out.println("variable1 name is "+variable1.getName()+" and Age is "+variable1.getAge());
		...
		System.out.println("variable2 name is "+variable2.getName()+" and Age is "+variable2.getAge());
		System.out.println("variable1 name is "+variable1.getName()+" and Age is "+variable1.getAge());
